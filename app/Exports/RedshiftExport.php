...
class RedshiftExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        return [
           ['galaxy_id', 'redshift_result', 'redshift_alt_result', 'optical_u', 'optical_v', 'optical_g', 'optical_r', 'optical_i', 'optical_z', 'infrared_three_six', 'infrared_four_five', 'infrared_five_eight', 'infrared_eight_zero', 'infrared_H', 'infrared_J', 'infrared_K', 'radio_one_four',],
        ];
    }
    public function collection()
    {
		...
		$completed = DB::select("
			SELECT assigned_calc_id, redshift_result, redshift_alt_result, optical_u, optical_v, optical_g, optical_r, optical_i, optical_z,
