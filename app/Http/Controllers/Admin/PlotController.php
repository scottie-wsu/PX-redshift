...
class PlotController extends Controller
{
	...
	public function __construct() {
		$this->plots["jobPerUser"] = new Plot("jobPerUser", "Number of Jobs per User", "select count(jobs.job_id) as 'val', users.id as 'label' from jobs, users where jobs.user_id = users.id GROUP by users.id", "Number of Jobs per User", "User ID", "Number of Jobs");
